...
// JSX (transpiled before it reaches to JS engine: Transpile means this code is converted to the code that browsers can understand, that react can understand), JSX is HTML like or XML , transpiled by parcel and done by babel package (babel is a JS compiler and transpiler, take jsx converts into code that js and react understands) (babel is not created by facebook)
